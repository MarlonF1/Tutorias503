...
<section class="hero-section overlay bg-cover">
      <div class="project-carousel">
        <div class="project-strip">
          <div class="project"><img src="images/backgrounds/mateblur.png" alt=""/></div>
          <div class="project"><img src="images/backgrounds/arduinoblur.png" alt=""/></div>
          <div class="project"><img src="images/backgrounds/phpblur.png" alt=""/></div>
        </div>
        <div class="project-screen">
          <div class="project-detail">
            <div class="project"><img src="images/backgrounds/mate.png" alt=""/></div>
            <div class="project"><img src="images/backgrounds/arduino.png" alt=""/></div>
            <div class="project"><img src="images/backgrounds/php.png" alt=""/></div>
          </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="d-flex align-items-center section-title justify-content-between">
          <h2 class="mb-0 text-nowrap mr-3">Nuestos Temarios</h2>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <a href="#course-single" class="btn btn-primary btn-sm">Aplicar ahora</a>
      </div>
    </div>
  </div>
  <!-- course item -->
