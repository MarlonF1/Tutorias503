...
<body>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-8 text-center text-lg-right">
            <ul class="list-inline">
              ...
              <!-- <li class="list-inline-item"><a id="cart-popover" class="btn" data-placement="bottom" title="Shopping Cart">
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
          ...
          -->
              ...
              <li class="nav-item @@contact">
                <a class="nav-link" href="#teacher">Tutores</a>
              </li>


              <li class="nav-item @@contact">
                <a class="nav-link" href="#courses">Clases</a>
              </li>


              <li class="nav-item @@contact">
                <a class="nav-link" href="#teacher">Planes</a>
              </li>
              <li class="nav-item @@contact">
        ...
        <div id="popover_content_wrapper" style="display: none">
          ...
          <div align="right">
            <a href="#" class="btn btn-primary" id="check_out_cart">
              <span class="ti-shopping-cart"></span> Check out
            </a>
            <a href="#" class="btn btn-default" id="clear_cart">
              <span class="ti-trash"></span> Clear
            </a>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-8 col-lg-7">
          <div class="row feature-blocks bg-gray justify-content-between">
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
              ...
              <h3 class="mb-xl-4 mb-lg-3 mb-4">Objetivo</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                et dolore magna aliqua. Ut enim ad</p>
            </div>
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
              <i class="ti-blackboard mb-xl-4 mb-lg-3 mb-4 feature-icon"></i>
              <h3 class="mb-xl-4 mb-lg-3 mb-4">Como trabajamos</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                et dolore magna aliqua. Ut enim ad</p>
            </div>
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
              <i class="ti-agenda mb-xl-4 mb-lg-3 mb-4 feature-icon"></i>
              <h3 class="mb-xl-4 mb-lg-3 mb-4">Cartera de Clientes</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                et dolore magna aliqua. Ut enim ad</p>
            </div>
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
              <i class="ti-write mb-xl-4 mb-lg-3 mb-4 feature-icon"></i>
              <h3 class="mb-xl-4 mb-lg-3 mb-4">Como acceder a nuestros planes</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                et dolore magna aliqua. Ut enim ad</p>
            </div>
          </div>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="d-flex align-items-center section-title justify-content-between">
            <h2 class="mb-0 text-nowrap mr-3">Nuestros Temarios</h2>
            <div class="border-top w-100 border-primary d-none d-sm-block"></div>
            <div>
              <a href="#courses" class="btn btn-sm btn-primary-outline ml-sm-3 d-none d-sm-block">Ver Mas</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        ...
        <?php foreach ($materiasconcategoria as $materia) : ?>

          <div class="col-lg-4 col-sm-6 mb-5">
            <div class="card p-0 border-primary rounded-0 hover-shadow">
              <img class="card-img-top rounded-0" src="images/courses/<?= $materia->img_categoria; ?>" width="400px" height="300px" alt="course thumb">
              <div class="card-body">
                <ul class="list-inline mb-2">
                  <li class="list-inline-item"><i class="ti-wallet mr-1 text-color"></i>$<?= $materia->costo; ?></li>
                  <li class="list-inline-item"><a class="text-color" href="#"><?= $materia->categoria; ?></a></li>
                </ul>
                <a href="#course-single">
                  <h4 class="card-title"><?= $materia->materia; ?></h4>
                </a>
                <p class="card-text mb-4"><?= $materia->descripcion; ?>.</p>
                <input type="hidden" name="quantity" id="quantity<?= $materia->id_materia;?>" class="form-control" value="1" />
                <input type="hidden" name="hidden_name" id="name<?= $materia->id_materia;?>" value="<?= $materia->materia;?>" />
                <input type="hidden" name="hidden_price" id="price<?= $materia->id_materia;?>" value="<?= $materia->costo;?>" />
                <input type="button" name="add_to_cart" id="<?= $materia->id_materia;?>" style="margin-top:5px;" class="btn btn-primary add_to_cart" value="Aplicar ahora" />
                <!-- <a href="#course-single" class="btn btn-primary btn-sm  add_to_cart">Aplicar ahora</a> -->
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <a href="#courses" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">Ver mas</a>
          </div>
        </div>
      </div>
  </section>
  ...
  <section class="section bg-primary">
    <div class="container">
      <div class="row">
        <div class="col-12 text-center">
          <h6 class="text-white font-secondary mb-0">¿Te gusta enseñar?</h6>
          <h2 class="section-title text-white">¡Se parte de nuestro staff de Tutores!</h2>
          <a href="#contact" class="btn btn-secondary">Inscribete</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-sm-4 position-relative success-video">
          <a class="play-btn venobox" href="https://youtu.be/C_PB_DX6shc" data-vbtype="video">
            <i class="ti-control-play"></i>
          </a>
        </div>
        <div class="col-lg-6 col-sm-8">
          <div class="bg-white p-5">
            <h2 class="section-title">Historia de exito</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat.</p>
...
-->
  ...
  <section class="section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12">
          <h2 class="section-title">Nuestros tutores</h2>
        </div>
        <!-- teacher -->
        ...
        <?php foreach ($tutores as $tutor) : ?>
          ...
          <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
            <div class="card border-0 rounded-0 hover-shadow">
              <img class="card-img-top rounded-0" src="images/teachers/<?= $tutor->img_tutor; ?>" height="400px" alt="400px" alt="teacher">
              <div class="card-body">
                <a href="teacher-single.html">
                  <h4 class="card-title"><?= $tutor->nombre_tutor; ?> <?= $tutor->apellido_tutor; ?></h4>
                </a>
                <p><?= $tutor->experiencia; ?></p>
                <ul class="list-inline">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 ml-auto bg-primary py-5 newsletter-block">
            <h3 class="text-white">Suscribete ahora</h3>
            <form action="#">
              <div class="input-wrapper">
                <input type="email" class="form-control border-0" id="newsletter" name="newsletter" placeholder="Email...">
                <button type="submit" value="send" class="btn btn-primary">Suscribete</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
            ...
            <ul class="list-unstyled">
              <li class="mb-3"><a class="text-color" href="#about">NOSOTROS</a></li>
              <li class="mb-3"><a class="text-color" href="#teacher">TUTORES</a></li>
              <li class="mb-3"><a class="text-color" href="#contact">CONTACTANOS</a></li>
            </ul>
          </div>
          <!-- links 
        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
